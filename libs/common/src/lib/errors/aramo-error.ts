...
export const ERROR_CODE_TO_HTTP_STATUS: Readonly<Record<ErrorCode, number>> = {
  ...
  RESUME_EXTRACTION_DRAFT_ALREADY_REVIEWED: 409,
  ...
  PRE_START_REQUIREMENT_CONFLICT: 409,
  ...
  PLACEMENT_START_COMMERCIAL_TERMS_REQUIRED: 422,
  ...
  // COMM-C3 — engagement gate (client-submittal denials 409, R15) + publish
  // validation (422).
  CLIENT_SUBMITTAL_ENGAGEMENT_POLICY_MISSING: 409,
  CLIENT_SUBMITTAL_ENGAGEMENT_INCOMPLETE: 409,
  CLIENT_SUBMITTAL_ENGAGEMENT_EVIDENCE_UNAVAILABLE: 409,
  CLIENT_SUBMITTAL_POLICY_INVALID: 422,
  // DOC-5 — document-readiness (RTR) denial (409).
  SUBMITTAL_RTR_NOT_EXECUTED: 409,
  ENGAGEMENT_POLICY_SCHEMA_INVALID: 422,
  ENGAGEMENT_POLICY_NOT_ACTIVATABLE: 422,
  MICROSOFT_REAUTHORIZATION_REQUIRED: 409,
  COMMUNICATION_EMAIL_CONSENT_DENIED: 409,
  MICROSOFT_PROVIDER_NOT_CONFIGURED: 409,
  PIPELINE_SUBMIT_REQUIRES_SUBMITTAL: 409,
  SUBMITTAL_PIPELINE_LINK_INVALID: 409,
  SUBMITTAL_RESUME_SELECTION_REQUIRED: 422,
  ...
  // Accidental-Add Correction — VOID refusals.
  PIPELINE_VOID_NOT_ALLOWED_FROM_STATE: 422,
  ...
  // Lane 2 / L2-F (F2) — InterviewSession refusals.
  CLIENT_SELECTION_PROCESS_INVALID: 409,
  INTERVIEW_SESSION_TRANSITION_CONFLICT: 409,
  INVALID_INTERVIEW_SESSION_TRANSITION: 422,
