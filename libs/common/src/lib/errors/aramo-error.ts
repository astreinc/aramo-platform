...
export const ERROR_CODE_TO_HTTP_STATUS: Readonly<Record<ErrorCode, number>> = {
  ...
  ENGAGEMENT_REFERENCE_NOT_FOUND: 422,  // T2-P3 RETAINED deprecated-compatible (no longer emitted)
  ENGAGEMENT_STATE_INVALID: 422,  // T2-P3 RETAINED deprecated-compatible (no longer emitted)
