...
// Per-module PrismaService for the integration module (T8-CONNECTOR-A).
//
...
export class PrismaService extends PrismaClient implements OnModuleDestroy {
  private readonly logger = new Logger('PrismaService (integration)');
  ...
  override async $connect(): Promise<void> {
    ...
    await super.$connect();
    this.logger.log('PrismaService (integration) connected');
  }
