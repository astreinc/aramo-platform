...
describe('Search PR-1 â scope catalog parity', () => {
  it('SEED_SCOPE_KEYS has 132 keys (the full seeded scope catalog)', () => {
    ...
    expect(SEED_SCOPE_KEYS).toHaveLength(138); // L4/P5 +2 offer:read + offer:read:financial -> 136+2=138. L2-I (D1) +1 integration:pipeline-mapping:write -> 135+1=136. L2-F +3 client-selection:create/read/transition; HYG-1 -3 dead orphan scopes.
  });
