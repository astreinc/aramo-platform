...
describe.skipIf(process.env['ARAMO_RUN_INTEGRATION'] !== '1')(
  ...
  () => {
    ...
    it('test 14 — getScopesByUserAndTenant returns tenant_admin scope set (110 scopes; TI-1D-D pipeline:resume:set + Track4/T4-D assignment + Track5/T5-P1 assignment:commercials + Track7/T7-P1 placement:permanent + Track7/T7-P2 placement:remedy:resolve + Track8/T8-P2 requisition:import)', async () => {
    ...
    it('test 17 — scope catalog correctness: 12-role staffing catalog + TI-1D-D pipeline:resume:set (tenant_admin 110, recruiter 61, candidate 7, tenant_owner 110, account_manager 86, sourcer 25, finance 10, auditor 5, recruiting_manager 56, delivery_manager 33, lead_recruiter 53, back_office 25)', async () => {
