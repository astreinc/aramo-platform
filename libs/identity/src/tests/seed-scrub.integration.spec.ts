...
const CATALOG_SCOPE_COUNT = 132; // +1 Slice#3 assignment:extend; +5 Track3/E1-b placement; +1 Track3/E4 placement:replace; +4 Track4/T4-D assignment; +2 Track5/T5-P1 assignment:commercials; +2 Track8/T8-P2 requisition:import; +2 Track7/T7-P1 placement:permanent; +1 Track7/T7-P2 placement:remedy:resolve; +1 Track7/T7-P3 placement:permanent:terms:write; +2 Track8/T8-CONNECTOR-A integration; +1 L8-B1 submittal-policy:write; +1 Approval requisition:approve; +1 L1-A requisition:create:establish (CATALOG-ONLY, no grant); +4 COMM-B2 communication:{read,voice:call,disposition:write,notes:write}
...
const CATALOG_ROLE_SCOPE_COUNT = 605; // +3 Slice#3 assignment:extend (AM + tenant_admin + tenant_owner); +18 Track3/E1-b placement matrix; +3 Track3/E4 placement:replace; +13 Track4/T4-D assignment matrix; +6 Track5/T5-P1 assignment:commercials matrix; +7 Track8/T8-P2 requisition:import matrix; +7 Track7/T7-P1 placement:permanent matrix; +3 Track7/T7-P2 placement:remedy:resolve matrix; +3 Track7/T7-P3 placement:permanent:terms:write matrix; +4 Track8/T8-CONNECTOR-A integration matrix; +3 L8-B1 submittal-policy:write (AM + tenant_admin + tenant_owner); +3 Approval requisition:approve (AM + tenant_admin + tenant_owner); +16 COMM-B2 communication matrix (4 scopes × recruiter/AM/tenant_admin/tenant_owner)
