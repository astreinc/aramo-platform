...
const CATALOG_SCOPE_COUNT = 129; // HYG-1 (2026-08-28) −3 dead orphan scopes (pipeline:remove, pipeline:add-activity, submittal-policy:write) → 132−3=129. Prior additive tally: +1 Slice#3 assignment:extend; +5 Track3/E1-b placement; +1 Track3/E4 placement:replace; +4 Track4/T4-D assignment; +2 Track5/T5-P1 assignment:commercials; +2 Track8/T8-P2 requisition:import; +2 Track7/T7-P1 placement:permanent; +1 Track7/T7-P2 placement:remedy:resolve; +1 Track7/T7-P3 placement:permanent:terms:write; +2 Track8/T8-CONNECTOR-A integration; +1 L8-B1 submittal-policy:write; +1 Approval requisition:approve; +1 L1-A requisition:create:establish (CATALOG-ONLY, no grant); +4 COMM-B2 communication:{read,voice:call,disposition:write,notes:write}
