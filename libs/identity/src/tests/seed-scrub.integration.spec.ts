...
const CATALOG_SCOPE_COUNT = 113; // +5 Track3/E1-b placement scopes; +1 Track3/E4 placement:replace; +4 Track4/T4-D assignment scopes; +2 Track5/T5-P1 assignment:commercials:read/write
...
const CATALOG_ROLE_SCOPE_COUNT = 545; // +18 Track3/E1-b placement matrix; +3 Track3/E4 placement:replace; +13 Track4/T4-D assignment matrix; +6 Track5/T5-P1 assignment:commercials:* (account_manager/tenant_admin/tenant_owner × 2)
