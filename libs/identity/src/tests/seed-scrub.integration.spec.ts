...
const CATALOG_SCOPE_COUNT = 115; // +5 Track3/E1-b placement; +1 Track3/E4 placement:replace; +4 Track4/T4-D assignment; +2 Track5/T5-P1 assignment:commercials; +2 Track8/T8-P2 requisition:import
...
const CATALOG_ROLE_SCOPE_COUNT = 552; // +18 Track3/E1-b placement matrix; +3 Track3/E4 placement:replace; +13 Track4/T4-D assignment matrix; +6 Track5/T5-P1 assignment:commercials matrix; +7 Track8/T8-P2 requisition:import matrix
