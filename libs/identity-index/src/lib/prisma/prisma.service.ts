...
// Per-module PrismaService for the identity-index module (Step 4a). Wraps the
// identity-index Prisma client; each module owns its own generated client
...
// the `$connect` override. Mirrors libs/talent-trust.
//
...
export class PrismaService extends PrismaClient implements OnModuleDestroy {
  ...
  override async $connect(): Promise<void> {
    ...
    await super.$connect();
    this.logger.log('PrismaService (identity-index) connected');
  }
