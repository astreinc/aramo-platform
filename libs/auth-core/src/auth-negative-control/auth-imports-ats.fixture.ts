...
// scope:auth project (`auth-core`) importing a scope:ats lib (`selection`). It
...
//     (auth-core's build tsconfig does not map @aramo/selection).
//
...
export const AUTH_NEGATIVE_CONTROL_REFERENCE = selectionAtsLib;
