...
// Per-module PrismaService for the ingestion module. Wraps the ingestion
// Prisma client; ingestion owns its own generated client (per the
// libs/talent + libs/consent + libs/identity prisma.service.ts precedent).
//
...
export class PrismaService extends PrismaClient implements OnModuleInit, OnModuleDestroy {
  ...
  async onModuleInit(): Promise<void> {
    await this.$connect();
    this.logger.log('PrismaService (ingestion) connected');
  }
