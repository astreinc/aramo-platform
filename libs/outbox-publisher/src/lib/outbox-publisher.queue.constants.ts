...
// the publisher can drain consent + selection + submittal outbox tables
// without creating a consent → selection|submittal import cycle
...
// with the same per-schema batch cap; selection + submittal each get
