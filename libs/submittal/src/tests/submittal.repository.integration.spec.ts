...
const TALENT_EVIDENCE_TR7_PATH = resolve(
  __dirname,
  '../../../talent-evidence/prisma/migrations/20260714120000_tr7_b1_education_certification/migration.sql',
);
const TALENT_EVIDENCE_HF1_PATH = resolve(
  __dirname,
...
const TALENT_EVIDENCE_1G_PATH = resolve(
  __dirname,
  ...
  () => {
    ...
    beforeAll(async () => {
      ...
      const migrationSqls = [
        ...
        readFileSync(TALENT_EVIDENCE_1G_PATH, 'utf8'),
