...
// M6 PR-2 — submittal-schema outbox repository.
//
...
// inside each SubmittalRepository write-method `$transaction`).
//
...
// to its own leaf lib to break the would-be consent → submittal cycle).
...
@Injectable()
export class SubmittalOutboxRepository {
