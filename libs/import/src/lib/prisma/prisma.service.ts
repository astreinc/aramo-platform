...
// Per-module PrismaService for the import module (PR-A8-1 Gate 5).
//
...
export class PrismaService extends PrismaClient implements OnModuleDestroy {
  private readonly logger = new Logger('PrismaService (import)');
  ...
  override async $connect(): Promise<void> {
    ...
    await super.$connect();
    this.logger.log('PrismaService (import) connected');
  }
