...
// the row's resolved_subject_id IS NULL IS the work-to-do signal; no
...
//     already-resolved rows (WHERE resolved_subject_id IS NULL);
//     (b) canonicalize's resolved_subject_id short-circuit (T2-2a Step
