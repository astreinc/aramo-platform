...
// (ADR-0029 I15): a scope:cip project (`matching`) importing a scope:ats lib
// (`selection`). It exists ONLY to PROVE that @nx/enforce-module-boundaries
...
//     (matching's build tsconfig does not map @aramo/selection).
//
...
export const I15_NEGATIVE_CONTROL_REFERENCE = selectionAtsLib;
