...
//   - to_state: required SelectionStateValue (closed-list validated via
//     @IsIn(SELECTION_STATE_VALUES)). Illegal-transition refusal
...
//     selection comes from the URL path param.
//
// tenant_id derived from JWT AuthContext (NOT in body).
export class TransitionSelectionRequestDto {
  @IsIn(SELECTION_STATE_VALUES as unknown as string[])
