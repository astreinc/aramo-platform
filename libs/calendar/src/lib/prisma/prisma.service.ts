...
// Per-module PrismaService for the calendar module (PR-A6 Gate 5+6 combined).
//
...
export class PrismaService extends PrismaClient implements OnModuleDestroy {
  private readonly logger = new Logger('PrismaService (calendar)');
  ...
  override async $connect(): Promise<void> {
    ...
    await super.$connect();
    this.logger.log('PrismaService (calendar) connected');
  }
