...
// Per-module PrismaService for the contact module (PR-A2 Gate 5).
// Same lazy-validation pattern as the workspace norm.
@Injectable()
export class PrismaService extends PrismaClient implements OnModuleDestroy {
  private readonly logger = new Logger('PrismaService (contact)');
  ...
  override async $connect(): Promise<void> {
    ...
    await super.$connect();
    this.logger.log('PrismaService (contact) connected');
  }
