...
// Portal P1 PR-3 — the per-record profile view. The R10-filtered PortalProfile
// for one record reachable through the caller's chain. A record id NOT in the
// chain (or unknown/malformed) resolves to a uniform 404 — surfaced here as an
// honest "not found" notice, no "exists but not yours" distinction. No trust UI,
// no consent-write UI (P2+).
      ...
      {profile !== null && (
        <Card title="Profile">
          <dl className="po-facts">
            <dt>Organization</dt>
            <dd className="po-mono">{profile.tenant_id}</dd>
            <dt>Status</dt>
