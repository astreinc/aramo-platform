...
const AUDIENCE = 'aramo-selection-transition-neg-shape';
const ALG = 'RS256';
...
describe.skipIf(process.env['ARAMO_RUN_INTEGRATION'] !== '1')(
  ...
  () => {
    ...
    it('200 selection-transition response contains no Match-Class vocabulary keys anywhere', async () => {
      // Create an selection first.
