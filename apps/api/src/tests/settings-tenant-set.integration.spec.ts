...
describe.skipIf(process.env['ARAMO_RUN_INTEGRATION'] !== '1')(
  ...
  () => {
    ...
    beforeAll(async () => {
      ...
      for (const p of [IDENTITY_INIT, IDENTITY_ALLOWED_DOMAIN, IDENTITY_DOMAIN_VERIFICATION, IDENTITY_SLUG, IDENTITY_INVITATION_MIG, IDENTITY_PROFILE, ENTITLEMENT_INIT, SETTINGS_INIT]) {
