...
const MIGRATIONS = [
  ...
  M('libs/requisition/prisma/migrations/20260802200000_recruiting_status_supersession/migration.sql'),
  ...
  () => {
    ...
    beforeAll(async () => {
      ...
      await setup.query(
        ...
        ['00000000-0000-7fff-8fff-000000000040', TALENT_ID, TENANT_ID],
      );
      await setup.query(
