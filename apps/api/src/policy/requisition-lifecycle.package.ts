...
//
// PR-4c — the RESTRICTIVE MATRIX, version 2.0.0. This is the first change in the
// track that alters what a recruiter can do, and it is published as DATA: the
// MATRIX table below IS the policy; the engine reads it generically. NO rule is
