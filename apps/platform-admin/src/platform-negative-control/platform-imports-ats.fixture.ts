...
// (`platform-admin`) importing a scope:ats lib (`selection`). It exists ONLY
...
//     (platform-admin's build tsconfig does not map @aramo/selection).
//
...
export const PLATFORM_NEGATIVE_CONTROL_REFERENCE = selectionAtsLib;
