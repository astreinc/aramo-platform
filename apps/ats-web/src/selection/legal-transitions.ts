...
// in libs/selection/src/lib/selection-state.ts's canTransition() (the
// BE source of truth). Amendment v1.1 / RULING 2: importing @aramo/selection
// is a forbidden domain edge; the selection matrix is an INLINE const
