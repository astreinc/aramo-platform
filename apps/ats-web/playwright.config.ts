...
// (apps/api :3000 + auth-service :3001) through the ats-web dev
...
const AUTH_STATE = 'apps/ats-web/e2e/.auth/recruiter.json';
...
export default defineConfig({
  ...
  webServer: {
    command:
      'npx vite --config apps/ats-web/vite.config.ts --port 4201 --strictPort',
    url: BASE_URL,
